...
<div className='back'>
      <div className='lfg'  >
        ...
        <h1 className='bbnh' >Our Expertise<br></br></h1>


        
        <p style={{ color: 'white', marginLeft: '28%',marginTop:'40px' }}>Solutions crafted with care. Your success, our purpose.</p>

        <div className="asdd" style={{ marginLeft: '500px',marginTop:'-82px' }}>
          <Link to="/home" className='oopt' >Home</Link>
          <Link to="/servies" className='oopt'>Service</Link>
